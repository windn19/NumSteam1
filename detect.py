...
def run(model,
    ...
    try:
        ...
        log_my.exception("Ошибка выполнения")
...
def parse_opt():
    ...
    parser.add_argument('--boxes', nargs=4, type=int, default=[])
    parser.add_argument('--lines', nargs=2, type=int, default=[])
    parser.add_argument('--cam-name', default='test_cam1'),
    parser.add_argument('--direct', choices=['up', 'down'], default='down')
